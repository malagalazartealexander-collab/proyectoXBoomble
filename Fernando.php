<?php
 echo "Su estructura general se basa en (public class) para nombre de la clase; (public static void main(String[] args){}) para comentar algo del programa y  tipo (nombreMetodo(parametros){}) para definir un método";
 echo"Cuenta con operadores para numeros, datos primitivos y no primitivos";
